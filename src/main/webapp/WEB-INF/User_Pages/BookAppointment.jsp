...
<link href="${pageContext.request.contextPath}/css/BookAppointment.css" rel="stylesheet">
</head>
<body>
<div class="dashboard">
      <!-- SIDEBAR -->
      ...
      <a href="#">
        <div class="logo">
          <img src="${pageContext.request.contextPath}/Images/Logo.png" alt="Logo image" class="img">
          </a>
          <h2>MotionRehab</h2>
        </div>
        ...
        <div class="menu">
          ...
          <a href="${pageContext.request.contextPath}/BookingAppointment"class="active">
          ...
          <a href="${pageContext.request.contextPath}/AppointmentHistory">
          ...
          <a href="${pageContext.request.contextPath}/ExercisePlans">
        ...
        <div class="topbar">
          ...
          <div class="top-right">
            ...
            <div class="profile">
              ...
              <img src="${pageContext.request.contextPath}/Images/SarinaRana.png" alt="Logo image" class="img">
            </div>
          </div>
        </div>
...
<textarea name="reason" placeholder="Enter the problem that you have been facing"></textarea>
    ...
    <div class="upload-box">
      ...
      <a href="${pageContext.request.contextPath}/UserDashboard" class="btn cancel-btn">
    Cancel
</a>
