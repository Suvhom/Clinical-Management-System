...
<link href="<%= request.getContextPath() %>/css/AppointmentHistory.css" rel="stylesheet">
</head>
<body>
<div class="dashboard">
      <!-- SIDEBAR -->
...
<a href="BookingAppointment">
          ...
          <div class="tabs">
            <a href="#" class="active">All Appointments</a>
            <a href="#">Upcoming</a>
            <a href="#">Completed</a>
            <a href="#">Cancelled</a>
          </div>
    ...
    <tr>
      ...
      <td>
        <div class="doctor">
          ...
          <c:out value="${appointment.providerName}" />
        </div>
      </td>

      <td>
        <c:out value="${appointment.treatment}" />
      </td>

      <td>
        <span class="status ${appointment.statusCssClass}">
      ...
      <td>
        <button class="action-btn">
          <c:out value="${appointment.actionLabel}" />
        </button>
