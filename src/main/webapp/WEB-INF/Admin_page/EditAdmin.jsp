...
<head>
    ...
    <title>Edit Admin - MotionRehab</title>
                ...
                <div class="form-card">
                    <form action="${pageContext.request.contextPath}/admin/update-admin" method="post" autocomplete="off">
                        ...
                        <section class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="username" name="username" value="${admin.username}" autocomplete="off" required>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="fullName" name="fullName" value="${admin.fullName}" autocomplete="off" required>
                                </div>

                                <div class="input-group">
                                    <label for="email">Email</label>
                                    <input type="email" id="email" name="email" value="${admin.email}" autocomplete="off" required>
                                </div>

                                <div class="input-group">
                                    <label for="phone">Phone</label>
                                    <input type="text" id="phone" name="phone" value="${admin.phone}" autocomplete="off" required>
                                </div>

                                <div class="input-group full">
                                    <label for="address">Address</label>
                                    <input type="text" id="address" name="address" value="${admin.address}" autocomplete="off" required>
                                </div>
                            </div>
                        </section>
                        ...
                        <div class="form-actions">
                            ...
                            <button class="save-btn" type="submit">Update Admin</button>
                        </div>
